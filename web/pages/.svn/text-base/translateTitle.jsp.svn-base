...
%>
    <form name="translateTitle" action="pages/titletranslationrequest.jsp" method="post" id="translateTitle" style="margin-top:10px;">
        <div class="inputrow">
        ...
        <div class="inputrow">
            <span><bean:message key="translatetitle.form.translate"/> : <strong>*</strong></span>
            <textarea id="translatedTitle" id="translatedTitle"></textarea>
            <div id="translatedTitleError" class="errormsg"><bean:message key="translatetitle.form.blanktitle"/></div>
        </div>
        ...
        <div class="action-layer">
             <button class="actionbutton" type="submit" id="submit"><bean:message key="translatetitle.form.translate"/></button>&nbsp;
...
<div id="accept" class="infowrap">
    <span><bean:message key="translatetitle.form.success"/></span>
</div>
        ...
        $("#translateTitle").submit( function() {
           ...
           if(translatedTitle == "") {
               ...
               $.ajax({
                  ...
                  url: "pages/titletranslationrequest.jsp",
                  //POST method is used
                  type: "POST",
                  //pass the data
                  data : data,
