<%-- 
    ...
    Created on : 7 Jun, 2011, 12:39:23 PM
    Author     : rkjangir
--%>
...
<%
    ...
    if(tId != null && lId != null && language != null && userId != null) {
        try {
            ...
            if(isChildTopic && (helper.getTranslationLimit(userId) > helper.countUserTranslation(userId)) && !helper.isTranslatorAssigned(topicId, linkId, langId)) {
                if(helper.assignTranslator(topicId, linkId, langId, userId)) {
                    out.println("true");
                } else {
                    out.println("false");
                }
