...
<%
    ...
    try{
        ...
        String language = (String)session.getAttribute("publisherLangId");
        if(language == null) {
            langId = 1;
        } else {
    ...
    String docPath = null;
    if(!isError) {
        docPath = show.getPublisherUrl(linkId, topicId, userId);
        url = "/pages/eContent/topics/"+docPath;
        path = "showPublisherPage.do?topicId="+topicId+"&linkId="+linkId;
...
<%
    } else if(role!=null && role.equals("publisher")) {
%>
