...
<%
    ...
    try {
        ...
        System.out.println("Hello");
        langId = Integer.parseInt((String)session.getAttribute("reviewerLangId"));
        System.out.println("Hello");
        ...
        System.out.println("Hello expection is here"+e);
%>
<br>
    <h3 align="center">There may be some problem while reviewing this content or you are not logged in. Please login now or try after some time.</h3>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function ajaxFunction() {
              var translated = document.review.translated.value;
              if(translated=="") {
                  alert("Translated content can not be empty.");
                  return false;
              }else {
                  if(xmlhttp) {
                    xmlhttp.open("POST","pages/eContent/reviewer/reviewContent.jsp",true);
            ...
            function markDefault() {
                ...
                if(translated=="") {
                    ...
                    document.review.setdefault.value = "yes";
    ...
    <body>
    <%
        if(role == null || role.trim().isEmpty() || !role.equals("reviewer")) {
    %>
    <br>
    <h3 align="center">Please login to review content.</h3>
    <p align="center">Click here to<a href="javascript:window.close();"> close </a>the window.</p>
    <%
    ...
    %>
    <div id="container">
        <form name ="review" method="post" action="pages/eContent/reviewer/reviewContent.jsp" onsubmit="return ajaxFunction();">
        <fieldset>

        <legend>Review It</legend>
        <div style="color:#036;padding-left:12px; padding-bottom: 5px;">Click keyboard button to use the virtual keyboard</div>
        <div style="color:#036;padding-left:12px; padding-bottom: 5px;">Please ignore any HTML tags if comes inside text you are reviewing. If you found anything wrong or abusive text in translated text, please either correct it or set to original.</div>
        <div class="fm-opt">
        ...
        <div id="fm-submit" class="fm-req">
          <input name="Submit" value="Mark as Reviewed" type="submit"/>
