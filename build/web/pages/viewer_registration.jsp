...
<%
            String url = "userregistration.do";
...
<html>
    <head>
        ...
        <title><bean:message key="label.register.userheading"/></title>
    ...
    <body>
        ...
        <div id="stylized" class="myform">
            ...
            <form id="regform" name="regform" method="post" action="registeruser.do" onsubmit="return validateUserRegistrationForm();">
                <h1><bean:message key="label.register.userheading"/></h1>
                <p>
                ...
                <div class="controls">
                    ...
                    <button type="reset" onclick="resetUserRegistrarationForm();"><bean:message key="label.button.reset"/></button>
                </div>
                <br />
            </form>
        </div>
